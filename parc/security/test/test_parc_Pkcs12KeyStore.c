 ...
 * Copyright 2013, 2014 Palo Alto Research Center, Inc. (PARC), a Xerox company.  All Rights Reserved.
 * The content of this file, whole or in part, is subject to licensing terms.
 * If distributing this software, include this License Header Notice in each
 * file and provide the accompanying LICENSE file.
 */
/**
 * @author Marc Mosko, Glenn Scott, Computing Science Laboratory, PARC
 * @copyright 2013, 2014 Palo Alto Research Center, Inc. (PARC), A Xerox Company. All Rights Reserved.
 */
#include <config.h>
...
LONGBOW_TEST_CASE(Global, parcPkcs12KeyStore_Open)
{
    ...
    PARCPkcs12KeyStore *keyStore = parcPkcs12KeyStore_Open("test_rsa.p12", "blueberry", PARC_HASH_SHA256);
...
LONGBOW_TEST_CASE(Global, parcPkcs12KeyStore_badpass)
{
    ...
    PARCPkcs12KeyStore *keyStore = parcPkcs12KeyStore_Open("test_rsa.p12", "orange", PARC_HASH_SHA256);
